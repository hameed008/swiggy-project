...
import { nonVegProducts } from '../constants/novegCardData';
...
const NonVeg = () => {
  ...
  return (
    <>
      <h1 className=' text-center text-xl font-bold'>Non Veg Food</h1>
            ...
            return (
              ...
              >
                <div className='w-full flex justify-between pb-[25px]'>
                  <h1 className='text-xl font-bold text-gray-900'>Chicken Biryani (20)</h1>
