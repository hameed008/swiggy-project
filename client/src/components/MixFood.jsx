...
import { mixFoodProducts } from '../constants/mixFood';
...
const MixFood = () => {
  ...
  return (
    <>
      <h1 className=' text-center text-xl font-bold'>Mix Food</h1>
      <div className="w-[1260px] flex flex-col items-center gap-5 mx-auto pt-[30px] pb-[50px]">
        {
          mixFoodProducts.map((product) => {
            return (
              ...
              >
                <div className='w-full flex justify-between pb-[25px]'>
                  <h1 className='text-xl font-bold text-gray-900'>Egg & Chicken (20)</h1>
